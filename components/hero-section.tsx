  ...
  return (
    <section id="hero" className="relative flex items-center justify-center overflow-hidden min-h-[100dvh]">
      ...
      */}
      ...
      <div className="relative z-10 w-full max-w-screen-lg xl:max-w-screen-xl 2xl:max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 text-center">
        <h1 className="font-serif text-white leading-tight tracking-tight text-balance text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl 2xl:text-7xl mb-4 sm:mb-6 lg:mb-8">
      ...
      {/* Scroll Indicator */}
      <div className="absolute left-1/2 -translate-x-1/2 bottom-6 sm:bottom-8 lg:bottom-10 xl:bottom-12 2xl:bottom-14 animate-bounce">
        <a
          href="#companies"
